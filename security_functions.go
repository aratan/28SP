...
// SecureMessage updates the message with security options
...
// SecureSerializeMessage serializes and encrypts a message with multiple layers
...
// SecureDeserializeMessage decrypts and deserializes a message
...
// SecureEncrypt provides AES-GCM encryption with random nonce
...
// SecureDecrypt provides AES-GCM decryption
...
// anonymizeMessage hides sensitive information from the message
...
// generateRandomRoutes generates random routes for onion routing
